...
for official injury/referee/arena reports and typed Opportunity-First ingestion.
"""

from main import app
from official_arena_service import router as official_arena_router
...
app.include_router(official_arena_router)
