  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'green-glow': 'linear-gradient(135deg, #39ff14 0%, #b2ff48 100%)',
        'red-glow': 'linear-gradient(135deg, #e82518 0%, #e51920 100%)',
        'blue-glow': 'linear-gradient(135deg, #4c419e 0%, #00578c 100%)',
        'purple-glow': 'linear-gradient(135deg, #b100b2 0%, #940bf5 100%)',
        'yellow-glow': 'linear-gradient(135deg, #ffff00 0%, #cdd926 100%)',
        'card-glass': 'linear-gradient(135deg, rgba(255,255,255,0.03) 0%, rgba(255,255,255,0.01) 100%)',
        'stat-gradient': 'linear-gradient(135deg, rgba(76,65,158,0.06) 0%, rgba(177,0,178,0.04) 100%)',
        // Legacy aliases
        'gold-glow': 'linear-gradient(135deg, #ffff00 0%, #ffff40 100%)',
        'cyan-glow': 'linear-gradient(135deg, #4c419e 0%, #00578c 100%)',
      },
      boxShadow: {
        ...
        'neon-red':       '0 0 20px rgba(232,37,24,0.6), 0 0 40px rgba(232,37,24,0.3), 0 4px 16px rgba(0,0,0,0.8)',
        'neon-red-sm':    '0 0 10px rgba(232,37,24,0.4)',
        'neon-blue':      '0 0 20px rgba(76,65,158,0.6), 0 0 40px rgba(76,65,158,0.3), 0 4px 16px rgba(0,0,0,0.8)',
        'neon-blue-sm':   '0 0 10px rgba(76,65,158,0.4)',
        'neon-purple':    '0 0 20px rgba(177,0,178,0.6), 0 0 40px rgba(177,0,178,0.3), 0 4px 16px rgba(0,0,0,0.8)',
        'neon-purple-sm': '0 0 10px rgba(177,0,178,0.4)',
        ...
        'cyan':           '0 0 20px rgba(76,65,158,0.5), 0 4px 16px rgba(0,0,0,0.8)',
        'cyan-sm':        '0 0 10px rgba(76,65,158,0.35)',
      },
      fontFamily: {
      ...
      keyframes: {
        pulseBlue: {
          '0%, 100%': { opacity: '1' },
          '50%': { opacity: '0.6', boxShadow: '0 0 16px rgba(76,65,158,0.6)' },
        },
        pulseGreen: {
          '0%, 100%': { opacity: '1' },
        ...
        pulseRed: {
          '0%, 100%': { opacity: '1' },
          '50%': { opacity: '0.5', boxShadow: '0 0 16px rgba(232,37,24,0.7)' },
        },
        shimmer: {
